...
| `subtitle` | `The AI Evaluation Studio` | Landing page subtitle below the title |
| `description` | `Agent X-ray Interface & Statistics` | Landing page description text (supports multi-line via YAML `\|-` block) |
