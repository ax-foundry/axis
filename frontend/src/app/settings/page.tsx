  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="ml-2 rounded px-2 py-0.5 text-xs text-text-muted hover:bg-gray-100 hover:text-text-primary dark:bg-gray-800 dark:hover:bg-gray-700"
      >
        Retry
      </button>
    </div>
        ...
        <div className="space-y-6">
            ...
            {!isLoaded && !themeError ? (
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs text-text-muted">
                  ...
                  or environment variables. See backend documentation for customization.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="rounded-xl border border-border bg-surface p-6">
            ...
            <div className="flex gap-3">
              <button
                className="rounded-lg border border-border bg-surface px-4 py-2 text-sm font-medium text-text-primary transition-colors hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800"
