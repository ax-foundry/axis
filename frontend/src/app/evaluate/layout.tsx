              ...
              if (isDisabled) {
                return (
                  <div key={step.id} className="flex flex-1 items-center">
                    <div className="group relative flex w-full cursor-not-allowed items-center gap-3 rounded-lg bg-gray-50 dark:bg-gray-900 px-4 py-2.5 opacity-50">
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : isPast
                          ...
                          : 'bg-gray-100 dark:bg-gray-800 text-text-muted hover:bg-gray-200 hover:text-text-primary'
                    )}
                  >
                    <div
                      className={cn(
