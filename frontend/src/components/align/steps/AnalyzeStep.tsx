    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between border-t border-border pt-6">
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-gray-100 px-4 py-2 font-medium text-text-secondary transition-colors hover:bg-gray-200 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-800"
        >
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={isEvaluating}
            className="flex items-center gap-2 rounded-lg border border-border px-4 py-2 font-medium text-text-secondary transition-colors hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-gray-900 dark:hover:bg-gray-800"
          >
