      ...
      <button
        ...
        className={cn(
          ...
          value === 1
            ...
            : 'hover:bg-success/10 bg-gray-100 text-text-secondary hover:text-success dark:bg-gray-800',
      ...
      <button
        ...
        className={cn(
          ...
          value === 0
            ...
            : 'hover:bg-error/10 bg-gray-100 text-text-secondary hover:text-error dark:bg-gray-800',
          disabled && 'cursor-not-allowed opacity-50'
        )}
      >
