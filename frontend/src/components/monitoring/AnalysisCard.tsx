  ...
  return (
    <div className="overflow-hidden rounded-lg border border-border bg-surface">
      ...
      <button
        ...
        className="flex w-full items-center gap-3 px-4 py-3 text-left transition-colors hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800"
      >
        {isExpanded ? (
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-3">
            <span className="rounded bg-gray-100 px-2 py-0.5 text-xs font-medium text-text-secondary dark:bg-gray-800">
              {record.metric_name}
            </span>
        ...
        <div className="border-t border-border px-4 py-4">
          ...
          {record.actual_output && (
            <div className="mb-4">
              ...
              <div className="max-h-40 overflow-y-auto rounded-lg bg-gray-50 p-3 dark:bg-gray-900">
