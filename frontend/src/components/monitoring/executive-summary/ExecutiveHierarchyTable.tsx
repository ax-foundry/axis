    ...
    <div className={cn('card', className)}>
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            onClick={onExpandAll}
            className="flex items-center gap-1 rounded-lg border border-border px-2 py-1 text-xs text-text-muted hover:bg-gray-50 hover:text-text-primary dark:bg-gray-900 dark:hover:bg-gray-800"
          >
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-border bg-gray-50 text-left dark:bg-gray-900">
            ...
            {visibleRows.map((nodeId) => {
              ...
              return (
                <tr
                  key={nodeId}
                  className={cn(
                    'border-b border-border last:border-0 hover:bg-gray-50 dark:bg-gray-900 dark:hover:bg-gray-800',
                    node.level === 'source' && 'bg-gray-50 font-medium dark:bg-gray-900/50'
                  )}
                >
