    ...
    <div className="border-border/30 border-b last:border-b-0">
      <button
        ...
        className={cn(
          ...
          canExpand ? 'cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900' : 'cursor-default'
        )}
      >
        {canExpand ? (
          isExpanded ? (
          ...
          isStatementGroup && verdictSignal
            ? isPositiveVerdict
              ...
              : isNegativeVerdict
                ...
                : 'bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-800'
            : 'bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 dark:bg-gray-800'
        )}
      >
        {isGroupExpanded ? (
