    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        {paginatedStops.map((rule) => (
          <div
            key={rule.id}
            className="rounded-lg border border-l-4 border-border border-l-red-400 bg-surface p-4 transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900/50"
          >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {getField(rule, 'threshold_type') && (
                    <span className="rounded-full bg-gray-100 dark:bg-gray-800 px-2.5 py-0.5 text-xs text-text-muted">
