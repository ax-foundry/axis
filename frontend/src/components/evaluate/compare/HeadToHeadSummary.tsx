...
export function HeadToHeadSummary({ rows, className }: HeadToHeadSummaryProps) {
  ...
  return (
    <div
      className={cn(
        'border-border/50 overflow-hidden rounded-xl border bg-surface shadow-sm',
        className
      )}
    >
      {/* Header */}
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-1 items-center gap-2">
        ...
        <div className="flex flex-1 justify-end">
          <div
            className="flex h-6 items-center justify-end rounded-l-md px-2 text-xs font-medium text-gray-700 dark:text-gray-300"
            style={{
              width: `${baselineWidth}%`,
              minWidth: '40px',
