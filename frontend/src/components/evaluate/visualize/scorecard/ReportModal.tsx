        ...
        <div className="border-border/50 flex items-center justify-between border-t px-6 py-4">
          ...
          {step === 'generating' && (
            <>
              <button
                onClick={cancel}
                className="rounded-lg border border-border px-3 py-2 text-sm text-text-secondary transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900"
              >
                Cancel
              </button>
          ...
          {step === 'result' && (
            <>
              <button
                ...
                className="flex items-center gap-2 rounded-lg border border-border px-3 py-2 text-sm text-text-secondary transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900"
              >
                ...
                <button
                  ...
                  className={cn(
                    ...
                    !report?.report_text
                      ...
                      : 'text-text-secondary hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900'
                  )}
                >
                  {copied ? (
                    <>
...
function ConfigStep({
  ...
  return (
    <div className="space-y-6 p-6">
              ...
              <button
                ...
                className={cn(
                  ...
                  reportMode === mode.value
                    ...
                    : 'border-border/50 hover:border-border hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900/50'
                )}
              >
                <div>
      ...
      {/* Extraction Config */}
      <div className="border-border/50 rounded-xl border bg-gray-50 dark:bg-gray-900/50 p-4">
      ...
      {(thoughts.length > 0 || isGenerating) && (
        <div className="border-border/50 border-b">
          <button
            ...
            className="flex w-full items-center justify-between px-6 py-3 text-left transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900/50"
          >
            <div className="flex items-center gap-2">
              {isGenerating ? (
          ...
          {thoughtsExpanded && (
            <div className="border-border/30 max-h-40 overflow-y-auto border-t bg-gray-50 dark:bg-gray-900/30 px-6 py-3">
              ...
              <div className="prose prose-sm max-w-none">
                <ReactMarkdown
                  ...
                  components={{
                    ...
                    code: ({ children }) => (
                      <code className="rounded bg-gray-100 dark:bg-gray-800 px-1.5 py-0.5 font-mono text-xs text-primary-dark">
                        {children}
                      </code>
                    ),
                    blockquote: ({ children }) => (
                    ...
                    thead: ({ children }) => (
                      <thead className="border-b border-border bg-gray-50 dark:bg-gray-900">{children}</thead>
                    ),
                    th: ({ children }) => (
                ...
                {/* Report Stats */}
                <div className="mt-6 rounded-lg bg-gray-50 dark:bg-gray-900/80 p-4">
