  ...
  return (
    <div className="space-y-4">
      <button
        ...
        className="border-border/60 -mx-3 flex w-[calc(100%+1.5rem)] items-center gap-3 rounded-lg border bg-gray-50 px-4 py-3 text-left transition-colors hover:bg-gray-100 dark:bg-gray-800 dark:bg-gray-900/80 dark:hover:bg-gray-700"
      >
        {isOpen ? (
