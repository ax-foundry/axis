    ...
    return (
      <div className="space-y-5 p-6">
              ...
              <tbody>
                {results.metric_results.map((metric) => (
                  <tr
                    ...
                    className="border-t border-border transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900/50"
                  >
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={reset}
            className="flex items-center gap-2 rounded-lg border border-border px-3 py-2 text-sm font-medium text-text-muted transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900 hover:text-text-secondary"
          >
      ...
      <div className="overflow-hidden rounded-lg border border-border">
        ...
        <div className="divide-y divide-border">
          ...
          <div className="flex items-center gap-3 px-4 py-3">
            ...
            <span className="rounded bg-gray-100 dark:bg-gray-800 px-2 py-0.5 text-xs font-medium text-text-muted">
        ...
        <div className="space-y-4 p-4">
          ...
          <div>
            ...
            <input
              ...
              disabled={isRunning}
              className="w-full rounded-lg border border-border bg-surface px-3 py-2 text-sm transition-colors focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 disabled:bg-gray-50 dark:bg-gray-900 disabled:text-text-muted"
            />
          </div>
          {/* LLM Model */}
          {selectedLlmCount > 0 && (
      ...
      {runError && (
        <div className="border-error/20 bg-error/5 rounded-lg border p-4">
          ...
          <div className="mt-3 flex gap-2">
            ...
            <button
              onClick={() => setCurrentStep('metrics')}
              className="rounded-lg border border-border px-3 py-1.5 text-xs font-medium text-text-muted transition-colors hover:bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-900"
            >
              Back to Metrics
            </button>
          </div>
