  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="border-border/50 rounded-lg border bg-gray-50 p-3 dark:bg-gray-900">
...
export function MetricDetailPopup({ node, position, onClose }: MetricDetailPopupProps) {
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between border-b border-border bg-gray-50 px-4 py-3 dark:bg-gray-900">
