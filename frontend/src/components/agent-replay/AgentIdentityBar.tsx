                ...
                {config?.avatar ? (
                  <div
                    className={cn(
                      ...
                      isSelected ? 'bg-primary-pale shadow-primary/20' : 'bg-gray-100 dark:bg-gray-800'
                    )}
                  >
                  ...
                  <div
                    className={cn(
                      ...
                      isSelected ? 'bg-primary/15 shadow-primary/20' : 'bg-gray-100 dark:bg-gray-800'
                    )}
                  >
                    <Bot
                      className={cn(
        ...
        {trace && (
          <>
            ...
            <div className="ml-auto flex flex-wrap items-center gap-2 text-xs">
              ...
              <span className="flex items-center gap-1 rounded-full bg-gray-100 dark:bg-gray-800 px-2.5 py-1 font-mono text-[10px] text-text-muted">
